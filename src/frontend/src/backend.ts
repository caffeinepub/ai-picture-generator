...
export class Backend implements backendInterface {
    ...
    async deleteGeneration(arg0: string): Promise<void> {
    ...
    async getGenerations(): Promise<Array<Generation>> {
        if (this.processError) {
            try {
                const result = await this.actor.getGenerations();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveGeneration(arg0: string, arg1: string, arg2: string): Promise<Generation> {
        if (this.processError) {
            try {
                const result = await this.actor.saveGeneration(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
